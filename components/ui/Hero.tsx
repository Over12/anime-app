  ...
  return (
    <section className='flex items-center spacing-section min-h-svh overflow-hidden'>
      <div className='min-w-1/3'>
        ...
        <motion.p initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }}><span className='font-semibold'>Don't know what to watch?</span> Let us help you find the perfect anime!</motion.p>
      </div>
