  ...
  return (
    <div key={anime.mal_id} className='flex'>
      <img src={anime.images.webp.large_image_url} alt={`Portada de ${anime.title}`} loading='lazy' className={clsx(
        'rounded-md aspect-[2/3] w-40 sm:w-56 shadow-md sm:shadow-xl h-auto',
      ...
      <div className='relative w-full px-3'>
        ...
        <div className='absolute flex flex-col text-center text-sm sm:text-base sm:flex-row gap-1 sm:gap-3 bottom-0 right-0 w-full sm:w-fit p-3'>
